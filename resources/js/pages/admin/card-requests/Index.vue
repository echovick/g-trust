...
import { Search, CreditCard, Eye, CheckCircle, Clock, XCircle } from 'lucide-vue-next';
...
const search = () => {
    searchForm.get('/admin/card-requests', {
        preserveState: true,
        preserveScroll: true,
    });
};
...
<template>
    <AdminLayout title="Card Requests">
        <div class="space-y-4 sm:space-y-6">
            <!-- Header -->
            <div>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Card Requests</h1>
                <p class="text-gray-600 mt-1">Review and approve new card requests</p>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="request in requests.data" :key="request.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900 capitalize">{{ request.card_type }} Card</div>
                                    <div class="text-sm text-gray-500 uppercase">
                                        {{ request.card_brand }}
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">{{ request.account.account_number }}</div>
                                    <div class="text-sm text-gray-500">{{ request.account.account_name }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link
                                        :href="`/admin/card-requests/${request.id}`"
