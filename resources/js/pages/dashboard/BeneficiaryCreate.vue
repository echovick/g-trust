...
const form = useForm({
    ...
    iban: '',
    country: '',
    beneficiary_type: 'domestic' as 'domestic' | 'international',
    email: '',
    phone: '',
});

const submit = () => {
    form.post('/dashboard/beneficiaries');
};
</script>
...
<template>
    <DashboardLayout title="Add Beneficiary">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Add a new beneficiary for faster transfers</p>
        </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p class="text-sm text-yellow-800">
                        <strong>Note:</strong> All beneficiaries will be verified by our team before they can be used for transfers.
