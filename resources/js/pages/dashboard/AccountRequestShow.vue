...
import { ArrowLeft, CheckCircle, XCircle, Clock, Wallet, User as UserIcon, Calendar } from 'lucide-vue-next';
...
<template>
    <DashboardLayout title="Account Request Details">
        <div class="space-y-6">
            <!-- Header -->
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <p class="text-gray-600">View the details of your account request</p>
                </div>
                <div>
                    <span :class="[
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <div class="flex items-start gap-3">
                            <div class="w-10 h-10 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0">
                                <Wallet :size="20" class="text-red-500" />
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 mb-1">Account Name</p>
                                <p class="font-semibold text-gray-900">{{ request.account_name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900 capitalize">{{ request.account_type }}</p>
                    </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-green-800 mb-4">
                            Your account request has been approved and your new account has been created.
                        </p>

                        <div v-if="request.createdAccount" class="bg-white border border-green-200 rounded-lg p-4 space-y-3">
                            <div>
                                <p class="text-xs text-green-700 mb-1">Account Number</p>
                                <p class="text-lg font-mono font-bold text-green-900">{{ request.createdAccount.account_number }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-green-700 mb-1">Account Name</p>
                                <p class="font-semibold text-green-900">{{ request.createdAccount.account_name }}</p>
                            </div>
                            <a
                                :href="`/dashboard/accounts/${request.createdAccount.id}`"
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-yellow-800 mb-4">
                            Your account request is currently being reviewed by our team.
                        </p>
                        <div class="bg-white border border-yellow-200 rounded-lg p-4">
                            ...
                            <ul class="text-sm text-yellow-800 space-y-2">
                                ...
                                <li class="flex items-start gap-2">
                                    <span class="text-yellow-500 mt-0.5">•</span>
                                    <span>A unique account number will be generated for your new account</span>
                                </li>
                            </ul>
                        </div>
                    </div>
