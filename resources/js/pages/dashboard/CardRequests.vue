...
import { Plus, Clock, CheckCircle, XCircle, CreditCard, Eye } from 'lucide-vue-next';
...
<template>
    <DashboardLayout title="Card Requests">
        <div class="space-y-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <p class="text-gray-600">View and track your card requests</p>
                <Link
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 capitalize">{{ request.card_type }} Card</h3>
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <p class="text-xs text-gray-500 mb-1">Linked Account</p>
                                    <p class="text-sm font-medium text-gray-900">{{ request.account.account_number }}</p>
                            ...
                            <!-- Approved Info -->
                            <div v-if="request.status === 'approved' && request.createdCard" class="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                                <p class="text-sm font-medium text-green-900 mb-1">✓ Card Created Successfully</p>
                                <p class="text-sm text-green-800">
                                    Card Number: <span class="font-mono font-semibold">{{ request.createdCard.card_number }}</span>
                                </p>
                        ...
                        <!-- View Details Button -->
                        <Link
                            :href="`/dashboard/card-requests/${request.id}`"
            ...
            <div v-else class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-2">No Card Requests Yet</h3>
                <p class="text-gray-600 mb-6">You haven't submitted any card requests</p>
                <Link
                    href="/dashboard/card-requests/create"
